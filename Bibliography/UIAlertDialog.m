...
- (instancetype)initWithStyle:(UIAlertDialogStyle)style title:(NSString *)title andMessage:(NSString *)message  andCancelButtonTitle: (NSString *) cancelButtonTitle
{
    if (self = [super init]) {
        self.style = style;
        self.title = title;
        if (cancelButtonTitle == nil) {
            ...
            self.cancelButtonTitle = NSLocalizedString( cancelButtonTitle, nil );
        };
...
- (void)showAlertControllerInViewController:(UIViewController *)viewController {
    ...
    if (![self.cancelButtonTitle isEqualToString:@""]) {
        UIAlertAction *closeAction = [UIAlertAction actionWithTitle: self.cancelButtonTitle style:UIAlertActionStyleCancel handler:nil];
